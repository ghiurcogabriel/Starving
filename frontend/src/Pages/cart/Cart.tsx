...
import { RestaurantType } from "../../context/cartTypes";
...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    const cartTotal =
      total + (restaurantData?.deliveryFee ?? 0) + (restaurantData?.costExtraDistance ?? 0);
      ...
      {cartItems.length !== 0 ? (
        <div className="cart-main-container">
          <div className="cart-contents">
            <button
              style={{ margin: "10px", backgroundColor: "#510707" }}
              onClick={() => emptyCart()}
              className="order"
            >
              delete cart
                ...
                <div className="cart-container">
                  <div className="food-container">
                    <div className="img-prod-container">
                      <img src={'../../assets/food-placeholder.png'} alt="" />
                    </div>
        ...
        <div className="nothing">
          ...
          <img src={'./public/assets/cart.gif'} alt="" />
        </div>
      )}
    </>
  );
